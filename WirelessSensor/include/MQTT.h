...
#define MQTT_DEFAULT_SHIFT 		100
#define MQTT_DEFAULT_INTERVAL 	60000
...
private:
	...
	void init(String broker_ip, int broker_port, unsigned int shift = MQTT_DEFAULT_SHIFT, unsigned int interval = MQTT_DEFAULT_INTERVAL, MqttStringSubscriptionCallback delegate_callback = NULL);
